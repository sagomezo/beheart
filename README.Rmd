...
The goal of `beheart` is to simplify the creation of bull's eye plots for left ventricle segmental data, supporting both 16- and 17-segment models. It provides powerful functions to visualize raw or summarized data, including comparisons between groups.
...
Here is a complete example showing how to prepare and plot data for two groups, creating a publication-quality figure with a single command.

```{r example, fig.width=11, fig.height=6}
